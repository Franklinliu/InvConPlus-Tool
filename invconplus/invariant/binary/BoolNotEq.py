from invconplus.invariant.binary.BoolBinary import BoolBinary
from invconplus.const import INVARIANT_STYLE
class BoolNotEq(BoolBinary):
    ...
    def __str__(self) -> str:
        if INVARIANT_STYLE == "VERISOL":
            ...
            desc = "BoolNotEq({0}, {1})".format(self.varInfos[0].name, self.varInfos[1].name)
            return desc