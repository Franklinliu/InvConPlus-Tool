...
namespace SolToBoogie
{
    ...
    public class TranslatorContext
    {
        ...
        // all VeriSol invariants for each function
        public Dictionary<FunctionDefinition, HashSet<FunctionCall>> FuncToVeriSolInvMap { get; private set;}
        ...
        public TranslatorContext(HashSet<Tuple<string, string>> ignoreMethods, bool _genInlineAttrInBpl, TranslatorFlags _translateFlags = null, String entryPointContract = "")
        {
            ...
            FuncToVeriSolInvMap = new Dictionary<FunctionDefinition, HashSet<FunctionCall>>();
        ...
        public int GetAndIncreaseHoudiniVarCount()
        {
            return houdiniVarCount++;
        }
        ...
        public void AddVeriSolInvariantToFunction(FunctionDefinition funcDef, FunctionCall verisolFuncCall)
        {
            if (!FuncToVeriSolInvMap.ContainsKey(funcDef))
            {
                FuncToVeriSolInvMap[funcDef] = new HashSet<FunctionCall>();
            }
            FuncToVeriSolInvMap[funcDef].Add(verisolFuncCall);
        }

        public HashSet<FunctionCall> GetVeriSolInvariantsByFunction(FunctionDefinition funcDef)
        {
            return FuncToVeriSolInvMap.ContainsKey(funcDef) ?
                FuncToVeriSolInvMap[funcDef] :
                new HashSet<FunctionCall>();
        }
