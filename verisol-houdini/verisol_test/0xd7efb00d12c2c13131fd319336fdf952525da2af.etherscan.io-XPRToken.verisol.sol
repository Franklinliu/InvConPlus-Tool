...
contract ERC20 is IERC20 {
    ...
    function transfer(address recipient, uint256 amount) public returns (bool) {
        ...
        VeriSol.AssumesBeginningOfFunction(_totalSupply==100000000000000);
        VeriSol.AssumesBeginningOfFunction(VeriSol.SumMapping(_balances)==100000000000000);
        //End of assumptions
        //Begin of invariants
        VeriSol.Requires(_totalSupply>0);
        VeriSol.Requires(_totalSupply==100000000000000);
        ...
        VeriSol.Requires(VeriSol.SumMapping(_balances)==100000000000000);
        VeriSol.Requires((_totalSupply) >= amount);
        VeriSol.Requires((_totalSupply) > amount);
        VeriSol.Requires((_totalSupply) != amount);
        ...
        VeriSol.Requires(amount <= (VeriSol.SumMapping(_balances)));
        VeriSol.Requires(amount < (VeriSol.SumMapping(_balances)));
        VeriSol.Requires(amount != (VeriSol.SumMapping(_balances)));
        VeriSol.Ensures(_totalSupply>0);
        VeriSol.Ensures(_totalSupply==100000000000000);
        VeriSol.Ensures(VeriSol.SumMapping(_balances)>0);
        VeriSol.Ensures(VeriSol.SumMapping(_balances)==100000000000000);
...
contract XPRToken is ERC20Burnable {
    ...
    constructor() public {
        ...
        VeriSol.AssumesEndingOfFunction(_totalSupply==100000000000000);
        VeriSol.AssumesEndingOfFunction(VeriSol.SumMapping(_balances)>0);
        VeriSol.AssumesEndingOfFunction(VeriSol.SumMapping(_balances)==100000000000000);
        ...
        _symbol = "XPR";
        _decimals = 4;
        _mint(msg.sender, uint256(100000000000000));
    }
    ...
    function contractInvariant() private view {
        ...
        VeriSol.ContractInvariant(_totalSupply==100000000000000);
        VeriSol.ContractInvariant(_decimals>0);
        VeriSol.ContractInvariant(_decimals==4);
        VeriSol.ContractInvariant(VeriSol.SumMapping(_balances)>0);
        VeriSol.ContractInvariant(VeriSol.SumMapping(_balances)==100000000000000);
