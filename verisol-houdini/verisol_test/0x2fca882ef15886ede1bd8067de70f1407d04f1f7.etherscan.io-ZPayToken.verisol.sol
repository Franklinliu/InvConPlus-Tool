...
contract ERC20 is IERC20 {
    ...
    function transfer(address recipient, uint256 amount) public returns (bool) {
        ...
        VeriSol.Requires(VeriSol.SumMapping(_balances)==201000000000000000000000);
        VeriSol.Requires(_totalSupply>0);
        VeriSol.Requires(_totalSupply==201000000000000000000000);
        ...
        VeriSol.Requires(amount < (_totalSupply));
        VeriSol.Requires(amount != (_totalSupply));
        VeriSol.Requires(msg.sender != recipient);
        VeriSol.Requires((VeriSol.SumMapping(_balances)) == (_totalSupply));
        VeriSol.Requires((VeriSol.SumMapping(_balances)) >= (_totalSupply));
        VeriSol.Requires((VeriSol.SumMapping(_balances)) <= (_totalSupply));
        VeriSol.Ensures(VeriSol.SumMapping(_balances)>0);
        VeriSol.Ensures(VeriSol.SumMapping(_balances)==201000000000000000000000);
        VeriSol.Ensures(_totalSupply>0);
        VeriSol.Ensures(_totalSupply==201000000000000000000000);
...
contract ERC20Mintable is ERC20, MinterRole {
    ...
    function mint(address account, uint256 amount) public onlyMinter() returns (bool) {
        ...
        VeriSol.Requires(account!=address(0));
        VeriSol.Requires(amount>0);
        VeriSol.Requires(amount==100500000000000000000000);
        VeriSol.Requires(msg.sender!=address(0));
        VeriSol.Requires(VeriSol.SumMapping(_balances)>0);
        VeriSol.Requires(VeriSol.SumMapping(_balances)==100500000000000000000000);
        VeriSol.Requires(_totalSupply>0);
        VeriSol.Requires(_totalSupply==100500000000000000000000);
