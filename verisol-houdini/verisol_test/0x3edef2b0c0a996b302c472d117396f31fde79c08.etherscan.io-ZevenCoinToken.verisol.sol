...
contract ERC20 is Context, IERC20 {
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns (bool) {
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender]._sub(subtractedValue, "ERC20: decreased allowance below zero"));
        return true;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        _balances[sender] = _balances[sender]._sub(amount, "ERC20: transfer amount exceeds balance");
    ...
    function _burn(address account, uint256 amount) internal {
        ...
        _balances[account] = _balances[account]._sub(amount, "ERC20: burn amount exceeds balance");
    ...
    function _burnFrom(address account, uint256 amount) internal {
        ...
        _approve(account, _msgSender(), _allowances[account][_msgSender()]._sub(amount, "ERC20: burn amount exceeds allowance"));
    }
}
...
contract ERC20Pausable is ERC20, Pausable {
    function transfer(address to, uint256 value) public whenNotPaused() returns (bool) {
        ...
        VeriSol.Requires(_totalSupply==77777777777000000000000000000);
        VeriSol.Requires(VeriSol.SumMapping(_balances)>0);
        VeriSol.Requires(VeriSol.SumMapping(_balances)==77777777777000000000000000000);
        ...
        VeriSol.Ensures(VeriSol.SumMapping(_balances)==77777777777000000000000000000);
        VeriSol.Ensures(_paused==false);
        VeriSol.Ensures(_totalSupply>0);
        VeriSol.Ensures(_totalSupply==77777777777000000000000000000);
...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public onlyOwner() {
        ...
        VeriSol.Requires(newOwner != (_owner));
...
contract ZevenCoinToken is ERC20FixedSupply {
    constructor() public ERC20FixedSupply(uint256(77777777777 * (10 ** 18)),"Zeven Coin","ZVC",uint8(18)) {
        //Begin of assumptions
    ...
    function contractInvariant() private view {
        ...
        VeriSol.ContractInvariant(VeriSol.SumMapping(_balances)==77777777777000000000000000000);
        ...
        VeriSol.ContractInvariant(_totalSupply==77777777777000000000000000000);
