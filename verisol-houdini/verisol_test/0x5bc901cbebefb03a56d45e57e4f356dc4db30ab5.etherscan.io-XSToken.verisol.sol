...
contract ERC20Mintable is ERC20, MinterRole {
    ...
    function mint(address to, uint256 value) public onlyMinter() returns (bool) {
        ...
        VeriSol.AssumesBeginningOfFunction(_totalSupply==10000000000000000000000000000);
        VeriSol.AssumesBeginningOfFunction(VeriSol.SumMapping(_balances)>0);
        VeriSol.AssumesBeginningOfFunction(VeriSol.SumMapping(_balances)==10000000000000000000000000000);
        //End of assumptions
        //Begin of invariants
        VeriSol.Requires(msg.sender!=address(0));
        ...
        VeriSol.Ensures(_totalSupply==10000000000000000000000000000);
        VeriSol.Ensures(VeriSol.SumMapping(_balances)>0);
        VeriSol.Ensures(VeriSol.SumMapping(_balances)==10000000000000000000000000000);
        //End of invariants
        _mint(to, value);
        return true;
    }
...
contract ERC20Pausable is ERC20, Pausable {
    function transfer(address to, uint256 value) public whenNotPaused() returns (bool) {
        ...
        VeriSol.Requires(_totalSupply==10000000000000000000000000000);
        VeriSol.Requires(VeriSol.SumMapping(_balances)>0);
        VeriSol.Requires(VeriSol.SumMapping(_balances)==10000000000000000000000000000);
        VeriSol.Requires(to!=address(0));
        VeriSol.Requires(msg.sender != to);
        VeriSol.Requires(value <= (_totalSupply));
        VeriSol.Requires(value < (_totalSupply));
        VeriSol.Requires(value != (_totalSupply));
        VeriSol.Requires(value <= (VeriSol.SumMapping(_balances)));
        VeriSol.Requires(value < (VeriSol.SumMapping(_balances)));
        VeriSol.Requires(value != (VeriSol.SumMapping(_balances)));
...
contract XSToken is ERC20Detailed, ERC20, ERC20Mintable, ERC20Pausable, ERC20Burnable, Ownable {
    ...
    constructor(string memory name, string memory symbol, uint256 totalSupply, uint8 decimals) public ERC20Detailed(name,symbol,decimals) {
        ...
        VeriSol.AssumesEndingOfFunction(_totalSupply==10000000000000000000000000000);
        ...
        VeriSol.AssumesEndingOfFunction(VeriSol.SumMapping(_balances)==10000000000000000000000000000);
        ...
        VeriSol.Ensures(_decimals != VeriSol.SumMapping(_balances));
        //End of invariants
        _mint(owner(), uint256(totalSupply * (10 ** uint(decimals))));
    }
    ...
    function contractInvariant() private view {
        ...
        VeriSol.ContractInvariant(_totalSupply==10000000000000000000000000000);
        ...
        VeriSol.ContractInvariant(VeriSol.SumMapping(_balances)==10000000000000000000000000000);
