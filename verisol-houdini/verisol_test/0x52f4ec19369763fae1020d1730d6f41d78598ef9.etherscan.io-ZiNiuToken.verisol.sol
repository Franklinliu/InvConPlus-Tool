...
contract ERC20Burnable is ERC20 {
    ...
    function burn(uint256 amount) public {
        ...
        VeriSol.AssumesBeginningOfFunction(VeriSol.SumMapping(_balances)==100000000000000000000000000);
        VeriSol.AssumesBeginningOfFunction(_totalSupply==100000000000000000000000000);
        //End of assumptions
        //Begin of invariants
        ...
        VeriSol.Ensures(VeriSol.SumMapping(_balances)==100000000000000000000000000);
        VeriSol.Ensures(_totalSupply==100000000000000000000000000);
        //End of invariants
...
contract PauserRole {
    ...
    function addPauser(address account) public onlyPauser() {
        ...
        VeriSol.Requires(msg.sender!=address(0));
        VeriSol.Requires(account != msg.sender);
        //End of invariants
        _addPauser(account);
    }
...
contract ERC20Pausable is ERC20, Pausable {
    function transfer(address to, uint256 value) public whenNotPaused() returns (bool) {
        ...
        VeriSol.Requires(VeriSol.SumMapping(_balances)==100000000000000000000000000);
        VeriSol.Requires(_totalSupply>0);
        VeriSol.Requires(_totalSupply==100000000000000000000000000);
...
contract ZiNiuToken is ERC20, ERC20Detailed, ERC20Burnable, ERC20Pausable {
    constructor() public ERC20Detailed("ZI NIU TOKEN","ZNT",18) {
        //Begin of assumptions
        VeriSol.AssumesEndingOfFunction(VeriSol.SumMapping(_balances)>0);
        VeriSol.AssumesEndingOfFunction(VeriSol.SumMapping(_balances)==100000000000000000000000000);
        VeriSol.AssumesEndingOfFunction(_totalSupply>0);
        VeriSol.AssumesEndingOfFunction(_totalSupply==100000000000000000000000000);
        VeriSol.AssumesEndingOfFunction(_paused==false);
        VeriSol.AssumesEndingOfFunction(VeriSol.SumMapping(_balances) >= _decimals);
        VeriSol.AssumesEndingOfFunction(VeriSol.SumMapping(_balances) > _decimals);
        VeriSol.AssumesEndingOfFunction(VeriSol.SumMapping(_balances) != _decimals);
        VeriSol.AssumesEndingOfFunction(_totalSupply >= _decimals);
        VeriSol.AssumesEndingOfFunction(_totalSupply > _decimals);
        VeriSol.AssumesEndingOfFunction(_totalSupply != _decimals);
        //End of assumptions
        //Begin of invariants
        ...
        VeriSol.Ensures(_totalSupply != _decimals);
        //End of invariants
        _mint(address(0x9B1f83e1d3C14D633226Fa756e16bdCa8054A7f1), uint256(60000000 * (10 ** 18)));
        _mint(address(0x15824B07A8d247081ceb4197d273a64F0dFdF900), uint256(40000000 * (10 ** 18)));
    }

    function contractInvariant() private view {
        VeriSol.ContractInvariant(VeriSol.SumMapping(_balances)>0);
        VeriSol.ContractInvariant(VeriSol.SumMapping(_balances)==100000000000000000000000000);
