...
contract ERC20Mintable is ERC20, MinterRole {
    ...
    function mint(address account, uint256 amount) public onlyMinter() returns (bool) {
        ...
        VeriSol.AssumesBeginningOfFunction(_totalSupply==5000000000000000000000000000);
        VeriSol.AssumesBeginningOfFunction(VeriSol.SumMapping(_balances)>0);
        VeriSol.AssumesBeginningOfFunction(VeriSol.SumMapping(_balances)==5000000000000000000000000000);
        //End of assumptions
        //Begin of invariants
        VeriSol.Requires(VeriSol.SumMapping(_balances)>0);
        VeriSol.Requires(VeriSol.SumMapping(_balances)==600000000000000000000000000);
        VeriSol.Requires(msg.sender!=address(0));
        VeriSol.Requires(amount>0);
        VeriSol.Requires(amount==4400000000000000000000000000);
        VeriSol.Requires(_totalSupply>0);
        VeriSol.Requires(_totalSupply==600000000000000000000000000);
        VeriSol.Requires(account!=address(0));
        ...
        VeriSol.Requires((VeriSol.SumMapping(_balances)) >= (_totalSupply));
        VeriSol.Requires((VeriSol.SumMapping(_balances)) <= (_totalSupply));
        VeriSol.Requires(msg.sender == account);
        VeriSol.Requires(amount >= (_totalSupply));
        VeriSol.Requires(amount > (_totalSupply));
        VeriSol.Requires(amount != (_totalSupply));
        VeriSol.Ensures(VeriSol.SumMapping(_balances)>0);
        VeriSol.Ensures(VeriSol.SumMapping(_balances)==5000000000000000000000000000);
        VeriSol.Ensures(_totalSupply>0);
        VeriSol.Ensures(_totalSupply==5000000000000000000000000000);
...
contract ERC20Pausable is ERC20, Pausable {
    function transfer(address to, uint256 value) public whenNotPaused() returns (bool) {
        ...
        //Begin of invariants
        VeriSol.Requires(VeriSol.SumMapping(_balances)>0);
        VeriSol.Requires(VeriSol.SumMapping(_balances)==5000000000000000000000000000);
        VeriSol.Requires(_paused==false);
        VeriSol.Requires(value>0);
        VeriSol.Requires(msg.sender!=address(0));
        VeriSol.Requires(to!=address(0));
        VeriSol.Requires(_totalSupply>0);
        VeriSol.Requires(_totalSupply==5000000000000000000000000000);
        ...
        VeriSol.Requires((VeriSol.SumMapping(_balances)) >= (_totalSupply));
        VeriSol.Requires((VeriSol.SumMapping(_balances)) <= (_totalSupply));
        VeriSol.Requires(value <= (_totalSupply));
        VeriSol.Requires(value < (_totalSupply));
        VeriSol.Requires(value != (_totalSupply));
...
contract XSRToken is ERC20Detailed, ERC20, ERC20Mintable, ERC20Pausable, ERC20Burnable, Ownable {
    ...
    constructor(string memory name, string memory symbol, uint256 totalSupply, uint8 decimals) public ERC20Detailed(name,symbol,decimals) {
        //Begin of assumptions
        VeriSol.AssumesEndingOfFunction(_owner!=address(0));
        VeriSol.AssumesEndingOfFunction(_decimals>0);
        VeriSol.AssumesEndingOfFunction(_decimals==18);
        VeriSol.AssumesEndingOfFunction(_paused==false);
        VeriSol.AssumesEndingOfFunction(_totalSupply>0);
        VeriSol.AssumesEndingOfFunction(_totalSupply==5000000000000000000000000000);
        VeriSol.AssumesEndingOfFunction(VeriSol.SumMapping(_balances)>0);
        VeriSol.AssumesEndingOfFunction(VeriSol.SumMapping(_balances)==5000000000000000000000000000);
        VeriSol.AssumesEndingOfFunction(_decimals <= _totalSupply);
        VeriSol.AssumesEndingOfFunction(_decimals < _totalSupply);
        VeriSol.AssumesEndingOfFunction(_decimals != _totalSupply);
        VeriSol.AssumesEndingOfFunction(_decimals <= VeriSol.SumMapping(_balances));
        VeriSol.AssumesEndingOfFunction(_decimals < VeriSol.SumMapping(_balances));
        VeriSol.AssumesEndingOfFunction(_decimals != VeriSol.SumMapping(_balances));
        //End of assumptions
        //Begin of invariants
    ...
    function contractInvariant() private view {
        ...
        VeriSol.ContractInvariant(_totalSupply==5000000000000000000000000000);
        VeriSol.ContractInvariant(VeriSol.SumMapping(_balances)>0);
        VeriSol.ContractInvariant(VeriSol.SumMapping(_balances)==5000000000000000000000000000);
