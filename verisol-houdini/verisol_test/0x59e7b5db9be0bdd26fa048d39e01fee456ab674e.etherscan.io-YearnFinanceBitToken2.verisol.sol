...
contract YearnFinanceBitToken2 is ERC20Interface, SafeMath {
    ...
    function approve(address spender, uint tokens) public returns (bool success) {
        ...
        VeriSol.Requires(VeriSol.SumMapping(balances)==5650000000000000000000);
        VeriSol.Requires(_totalSupply>0);
        VeriSol.Requires(_totalSupply==5650000000000000000000);
        ...
        VeriSol.Ensures(_totalSupply==5650000000000000000000);
        VeriSol.Ensures(VeriSol.SumMapping(balances)>0);
        VeriSol.Ensures(VeriSol.SumMapping(balances)==5650000000000000000000);
    ...
    function contractInvariant() private view {
        ...
        VeriSol.ContractInvariant(VeriSol.SumMapping(balances)==5650000000000000000000);
        VeriSol.ContractInvariant(_totalSupply>0);
        VeriSol.ContractInvariant(_totalSupply==5650000000000000000000);
