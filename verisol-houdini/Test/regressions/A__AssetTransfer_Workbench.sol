...
//
// The wrapper contract AssetTransferWrper invokes functions from AssetTransfer.
// The inheritance order of AssetTransferWrper ensures that functions and variables in AssetTransfer 
// are not shadowed by WorkbenchBase.
// Any access of WorkbenchBase function or variables is qualified with WorkbenchBase
//
contract AssetTransferWrper is WorkbenchBase, AssetTransfer {
    // 
    // Constructor
    // 
