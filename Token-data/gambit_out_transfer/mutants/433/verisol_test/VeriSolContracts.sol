...
library VeriSol {
    ...
    /// Assumptions
    ///                                                                                                                           
    ///                                                                                                                                * Calling this function within a function f VeriSol.Assumes(E) installs
    ///                                                                                                                           E as an assumption of f. 
    function AssumesBeginningOfFunction(bool b) external pure;

    function AssumesEndingOfFunction(bool b) external pure;
    ...
    function SumMapping(mapping(uint256 => uint256) storage a) external pure returns (uint256);

    function SumMapping(mapping(string => uint256) storage a) external pure returns (uint256);

    function SumMapping(mapping(bytes32 => uint256) storage a) external pure returns (uint256);

    function SumMappingIntInt(mapping(uint256 => uint256) storage a) external pure returns (uint256);
    ...
    function Old(bool x) external pure returns (bool);
