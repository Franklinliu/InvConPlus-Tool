...
contract TOKENERC20 {
   ...
   event Approval(address indexed _owner, address indexed _spender, uint256 _value);
    ...
    function _transfer(address _from, address _to, uint256 _value) internal {
        ...
        /// RequireMutation(`LockList[msg.sender] == false` |==> `true`) of: `require (LockList[msg.sender] == false,"ERC20: Caller Locked !");            // Check if msg.sender is locked or not`
        require (true,"ERC20: Caller Locked !");            // Check if msg.sender is locked or not
