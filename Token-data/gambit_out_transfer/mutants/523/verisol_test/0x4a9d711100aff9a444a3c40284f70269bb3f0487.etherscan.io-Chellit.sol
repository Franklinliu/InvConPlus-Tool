   ...
   event Approval(address indexed _owner, address indexed _spender, uint256 _value);
    ...
    function _transfer(address _from, address _to, uint256 _value) internal {
       ...
       // Check if sender balance is locked 
        ...
        /// DeleteExpressionMutation(`require (stage >= LockedTokens[_from],"ERC20: transfer amount exceeds Senders Locked Amount")` |==> `assert(true)`) of: `require (stage >= LockedTokens[_from],"ERC20: transfer amount exceeds Senders Locked Amount");`
        assert(true);
