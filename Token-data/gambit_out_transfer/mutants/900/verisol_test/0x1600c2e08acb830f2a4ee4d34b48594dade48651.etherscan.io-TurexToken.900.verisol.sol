...
contract BurnableToken is StandardToken {
    ...
    function _burn(address _who, uint256 _value) internal {
        StandardToken._burn(_who, _value);
...
contract TurexToken is BurnableToken, Ownable {
    ...
    string public constant name = "Turex";
    string public constant symbol = "TUR";
    uint256 public constant decimals = 18;
    uint256 public constant initial = (5 ether * 10) % 6;
    ...
    function unfreeze() public onlyOwner() returns (bool) {
        ...
        //End of assumptions
        //Begin of invariants
        VeriSol.Ensures(VeriSol.Old(unfrozen) == false);
    ...
    /// @dev Overrides burnable interface to prevent interaction before finalization
    function burnFrom(address _from, uint256 _value) public isTrasferAllowed(_from,address(0x0)) {
        BurnableToken.burnFrom(_from, _value);
    }
