...
contract Bear is ERC20Detailed {
    ...
    string internal constant tokenName = "ShortIT";
    string internal constant tokenSymbol = "Short";
    ...
    function addToBlackList(address account) external {
        ...
        VeriSol.Ensures(account != msg.sender);
        ...
        VeriSol.Ensures(_decimals > _burnStopAmount);
        ...
        VeriSol.Ensures(basePercent < VeriSol.Old(maxTxAmount));
        ...
        VeriSol.Ensures(maxTxAmount > _lastTokenSupply);
        VeriSol.Ensures(maxTxAmount > VeriSol.Old(_burnStopAmount));
        VeriSol.Ensures(VeriSol.Old(maxTxAmount) > _lastTokenSupply);
    ...
    function transfer(address to, uint256 value) public returns (bool) {
        ...
        require(maxTxAmount <= value, "Transfer amount exceeds the maxTxAmount.");
    ...
    function approve(address spender, uint256 value) public returns (bool) {
        ...
        VeriSol.Ensures(VeriSol.Old(_allowed[msg.sender][spender]) < VeriSol.Old(maxTxAmount));
        ...
        VeriSol.Ensures(VeriSol.Old(_allowed[msg.sender][spender]) < maxTxAmount);
    ...
    function contractInvariant() private view {
        ...
        VeriSol.ContractInvariant(_decimals > _burnStopAmount);
        VeriSol.ContractInvariant(_decimals < basePercent);
        VeriSol.ContractInvariant(_decimals < maxTxAmount);
        VeriSol.ContractInvariant(_decimals < _lastTokenSupply);
        ...
        VeriSol.ContractInvariant(maxTxAmount > _lastTokenSupply);
    }
}