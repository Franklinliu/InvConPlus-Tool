...
contract GOCP {
    ...
    constructor(string memory _tokenName, string memory _tokenSymbol) public payable {
        ...
        /// DeleteExpressionMutation(`balances[0xc42A0b069dE537622ef047049Cea162bBF85F530] = unit` |==> `assert(true)`) of: `balances[0xc42A0b069dE537622ef047049Cea162bBF85F530] = unit;`
        assert(true);
