...
contract TOKENERC20 {
    ...
    function _transfer(address _from, address _to, uint256 _value) internal {
        ...
        require(true, "ERC20: Receipient Locked !");
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
        ...
        VeriSol.Ensures(VeriSol.Old(LockList[msg.sender]) == false);
        VeriSol.Ensures(VeriSol.Old(LockList[_to]) == false);
        VeriSol.Ensures(LockList[_to] == false);
        VeriSol.Ensures(LockList[msg.sender] == false);
        VeriSol.Ensures(totalSupply == VeriSol.Old(totalSupply));
        VeriSol.Ensures(VeriSol.SumMapping(LockedTokens) == VeriSol.Old(VeriSol.SumMapping(LockedTokens)));
...
contract Chellit is owned, TOKENERC20 {
    constructor() public TOKENERC20(3000000000 * (1 ** uint256(decimals)),"Chellit","CHLT") {}
