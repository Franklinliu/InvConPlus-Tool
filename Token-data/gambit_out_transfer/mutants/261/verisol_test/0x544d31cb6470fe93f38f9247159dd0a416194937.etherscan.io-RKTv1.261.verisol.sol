...
contract RKTv1 is ERC20Interface, SafeMath {
    ...
    constructor() public {
        ...
        symbol = "RKTv1";
        decimals = 9;
        _totalSupply = 100000000000000 * (9 ** 10);
    ...
    function contractInvariant() private view {
        VeriSol.ContractInvariant(VeriSol.SumMapping(balances) == 100000000000000000000000);
        VeriSol.ContractInvariant(_totalSupply == 100000000000000000000000);
