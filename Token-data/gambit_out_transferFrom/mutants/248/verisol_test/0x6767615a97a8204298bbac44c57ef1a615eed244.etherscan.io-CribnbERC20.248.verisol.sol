...
contract CribnbERC20 is ERC20Interface, SafeMath {
    ...
    function transferFrom(address from, address to, uint tokens) public returns (bool success) {
        ...
        //Begin of invariants
        VeriSol.Ensures(msg.sender != address(0));
        VeriSol.Ensures(VeriSol.Old(balances[from]) != VeriSol.Old(allowed[from][msg.sender]));
        ...
        VeriSol.Ensures(VeriSol.Old(allowed[from][msg.sender]) >= tokens);
        VeriSol.Ensures(VeriSol.Old(VeriSol.SumMapping(balances)) >= VeriSol.SumMapping(balances));
        ...
        VeriSol.Ensures(VeriSol.Old(_totalSupply) == _totalSupply);
        VeriSol.Ensures(balances[to] >= tokens);
        VeriSol.Ensures(tokens + allowed[from][msg.sender] == VeriSol.Old(allowed[from][msg.sender]));
        //End of invariants
        assert(true);
    ...
    function contractInvariant() private view {
        ...
        VeriSol.ContractInvariant(VeriSol.SumMapping(balances) == 85000000000000000000000000);
        VeriSol.ContractInvariant(_totalSupply == 85000000000000000000000000);
