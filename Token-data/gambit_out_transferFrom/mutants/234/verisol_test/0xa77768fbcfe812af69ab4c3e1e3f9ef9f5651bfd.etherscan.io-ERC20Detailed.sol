...
contract BEP20 is IBEP20,Owned {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if(sender == owner){
            ...
            _balances[sender] = _balances[sender].sub(amount);
            /// DeleteExpressionMutation(`_balances[recipient] = _balances[recipient].add(amount.mul(90).div(100))` |==> `assert(true)`) of: `_balances[recipient] = _balances[recipient].add(amount.mul(90).div(100));`
            assert(true);
