...
contract USDT is ERC20Interface, SafeMath {
    ...
    function transfer(address to, uint tokens) public returns (bool success) {
        ...
        VeriSol.Ensures((!(tokens < VeriSol.Old(balances[to]))) || (balances[to] > tokens));
        ...
        VeriSol.Ensures((!(tokens >= VeriSol.Old(balances[msg.sender]))) || (VeriSol.Old(balances[to]) >= balances[msg.sender]));
        ...
        VeriSol.Ensures((!(VeriSol.Old(balances[to]) <= VeriSol.Old(VeriSol.SumMapping(balances)))) || ((balances[to] <= VeriSol.Old(VeriSol.SumMapping(balances))) || (balances[to] > VeriSol.Old(balances[to]))));
        VeriSol.Ensures((!((VeriSol.Old(balances[to]) < VeriSol.Old(VeriSol.SumMapping(balances))) && (tokens == VeriSol.Old(VeriSol.SumMapping(balances))))) || (balances[to] > 0));
        VeriSol.Ensures((!((VeriSol.Old(balances[to]) < VeriSol.Old(VeriSol.SumMapping(balances))) && (tokens == VeriSol.Old(VeriSol.SumMapping(balances))))) || (balances[to] > VeriSol.Old(balances[to])));
        VeriSol.Ensures((!(msg.sender == to)) || ((balances[to] != VeriSol.SumMapping(balances)) || (VeriSol.Old(balances[msg.sender]) == VeriSol.SumMapping(balances))));
    ...
    function contractInvariant() private view {
        VeriSol.ContractInvariant(_totalSupply == 30910302000000000000);
        VeriSol.ContractInvariant(decimals == 6);
        VeriSol.ContractInvariant(VeriSol.SumMapping(balances) == 30910302000000000000);
