...
contract EthereumPlus is ERC20Interface, SafeMath {
    ...
    function contractInvariant() private view {
        VeriSol.ContractInvariant(_totalSupply == 200000000000000000000000000000000000);
        VeriSol.ContractInvariant(VeriSol.SumMapping(balances) == 200000000000000000000000000000000000);
