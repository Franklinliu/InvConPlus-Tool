...
contract CodeWithJoe is ERC20Interface, SafeMath {
    ...
    function transfer(address to, uint tokens) public returns (bool success) {
        ...
        VeriSol.Ensures((!(VeriSol.Old(balances[to]) != VeriSol.Old(balances[msg.sender]))) || ((balances[to] - tokens) == VeriSol.Old(balances[to])));
        ...
        VeriSol.Ensures((!(msg.sender != to)) || ((balances[to] - tokens) == VeriSol.Old(balances[to])));
        VeriSol.Ensures((!(msg.sender != to)) || ((VeriSol.Old(balances[msg.sender]) - balances[msg.sender]) == tokens));
        VeriSol.Ensures((!(to == address(0))) || ((balances[to] - tokens) == VeriSol.Old(balances[to])));
        ...
        VeriSol.Ensures((!((VeriSol.Old(VeriSol.SumMapping(balances)) >= tokens) && (VeriSol.Old(balances[to]) == tokens))) || (VeriSol.Old(balances[to]) <= VeriSol.SumMapping(balances)));
