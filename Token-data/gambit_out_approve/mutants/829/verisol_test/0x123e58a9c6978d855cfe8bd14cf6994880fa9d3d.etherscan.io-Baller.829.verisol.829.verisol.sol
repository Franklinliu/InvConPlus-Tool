...
contract Baller is ERC20Interface, SafeMath {
    ...
    function transfer(address to, uint tokens) public returns (bool success) {
        ...
        VeriSol.Ensures((!(to != msg.sender)) || ((VeriSol.Old(balances[msg.sender]) - balances[msg.sender]) == tokens));
        ...
        VeriSol.Ensures((!((tokens > VeriSol.Old(balances[to])) && (tokens == VeriSol.Old(balances[msg.sender])))) || (tokens != balances[msg.sender]));
        VeriSol.Ensures((!((tokens > VeriSol.Old(balances[to])) && (tokens == VeriSol.Old(balances[msg.sender])))) || (balances[msg.sender] <= VeriSol.SumMapping(balances)));
        VeriSol.Ensures((!((tokens > VeriSol.Old(balances[to])) && (tokens == VeriSol.Old(balances[msg.sender])))) || (balances[msg.sender] <= VeriSol.Old(VeriSol.SumMapping(balances))));
        VeriSol.Ensures((!((tokens > VeriSol.Old(balances[to])) && (tokens == VeriSol.Old(balances[msg.sender])))) || (balances[msg.sender] != balances[to]));
        VeriSol.Ensures((!(tokens > 0)) || ((((VeriSol.Old(balances[to]) != balances[to]) || (VeriSol.Old(balances[msg.sender]) <= VeriSol.SumMapping(balances))) || (VeriSol.Old(balances[msg.sender]) <= VeriSol.SumMapping(balances))) || (VeriSol.Old(balances[msg.sender]) >= balances[to])));
