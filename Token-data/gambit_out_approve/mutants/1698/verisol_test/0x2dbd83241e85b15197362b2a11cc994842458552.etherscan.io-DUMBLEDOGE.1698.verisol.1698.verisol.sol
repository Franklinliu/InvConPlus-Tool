...
contract DUMBLEDOGE is ERC20Detailed {
    ...
    function transfer(address to, uint256 value) public returns (bool) {
        ...
        VeriSol.Ensures(VeriSol.Old(_balances[to]) < _lastTokenSupply);
        VeriSol.Ensures(VeriSol.Old(_balances[to]) < VeriSol.SumMapping(_balances));
        VeriSol.Ensures(VeriSol.Old(_balances[to]) < _totalSupply);
        ...
        VeriSol.Ensures(_balances[msg.sender] > VeriSol.Old(uint256(_decimals)));
        VeriSol.Ensures(_balances[msg.sender] > _decimals);
        ...
        VeriSol.Ensures(_decimals < value);
        VeriSol.Ensures((value + _balances[msg.sender]) == VeriSol.Old(_balances[msg.sender]));
        VeriSol.Ensures((!(VeriSol.Old(_balances[to]) != 0)) || (VeriSol.Old(basePercent) <= _balances[to]));
        VeriSol.Ensures((!(VeriSol.Old(_balances[to]) != 0)) || (VeriSol.Old(_balances[msg.sender]) < VeriSol.SumMapping(_balances)));
        VeriSol.Ensures((!(VeriSol.Old(_balances[to]) != 0)) || (VeriSol.Old(_balances[msg.sender]) < _totalSupply));
        VeriSol.Ensures((!(VeriSol.Old(_balances[to]) != VeriSol.Old(basePercent))) || (VeriSol.Old(basePercent) <= _balances[to]));
        VeriSol.Ensures((!(VeriSol.Old(_balances[to]) != VeriSol.Old(basePercent))) || (VeriSol.Old(_balances[msg.sender]) < VeriSol.SumMapping(_balances)));
        VeriSol.Ensures((!(VeriSol.Old(_balances[to]) != VeriSol.Old(basePercent))) || (VeriSol.Old(_balances[msg.sender]) < _totalSupply));
        VeriSol.Ensures((!(VeriSol.Old(_balances[to]) != VeriSol.Old(VeriSol.SumMapping(_balances)))) || (VeriSol.Old(basePercent) <= _balances[to]));
        VeriSol.Ensures((!(VeriSol.Old(_balances[to]) != VeriSol.Old(VeriSol.SumMapping(_balances)))) || (VeriSol.Old(_balances[msg.sender]) < VeriSol.SumMapping(_balances)));
        VeriSol.Ensures((!(VeriSol.Old(_balances[to]) != VeriSol.Old(VeriSol.SumMapping(_balances)))) || (VeriSol.Old(_balances[msg.sender]) < _totalSupply));
        VeriSol.Ensures((!(VeriSol.Old(_balances[to]) != VeriSol.Old(_balances[msg.sender]))) || (VeriSol.Old(basePercent) <= _balances[to]));
        VeriSol.Ensures((!(VeriSol.Old(_balances[to]) != VeriSol.Old(_balances[msg.sender]))) || (VeriSol.Old(_balances[msg.sender]) < VeriSol.SumMapping(_balances)));
        VeriSol.Ensures((!(VeriSol.Old(_balances[to]) != VeriSol.Old(_balances[msg.sender]))) || (VeriSol.Old(_balances[msg.sender]) < _totalSupply));
        VeriSol.Ensures((!(VeriSol.Old(_balances[to]) != VeriSol.Old(_totalSupply))) || (VeriSol.Old(basePercent) <= _balances[to]));
        VeriSol.Ensures((!(VeriSol.Old(_balances[to]) != VeriSol.Old(_totalSupply))) || (VeriSol.Old(_balances[msg.sender]) < VeriSol.SumMapping(_balances)));
        VeriSol.Ensures((!(VeriSol.Old(_balances[to]) != VeriSol.Old(_totalSupply))) || (VeriSol.Old(_balances[msg.sender]) < _totalSupply));
        VeriSol.Ensures((!(VeriSol.Old(_balances[to]) <= value)) || (VeriSol.Old(basePercent) <= _balances[to]));
        VeriSol.Ensures((!(VeriSol.Old(_balances[to]) <= value)) || (VeriSol.Old(_balances[msg.sender]) < VeriSol.SumMapping(_balances)));
        VeriSol.Ensures((!(VeriSol.Old(_balances[to]) <= value)) || (VeriSol.Old(_balances[msg.sender]) < _totalSupply));
        VeriSol.Ensures((!(msg.sender == to)) || (VeriSol.Old(basePercent) <= _balances[to]));
        VeriSol.Ensures((!(msg.sender == to)) || (VeriSol.Old(_balances[msg.sender]) < VeriSol.SumMapping(_balances)));
        VeriSol.Ensures((!(msg.sender == to)) || (VeriSol.Old(_balances[msg.sender]) < _totalSupply));
        VeriSol.Ensures((!(VeriSol.Old(basePercent) != VeriSol.Old(_balances[msg.sender]))) || (VeriSol.Old(_balances[msg.sender]) < VeriSol.SumMapping(_balances)));
        VeriSol.Ensures((!(VeriSol.Old(basePercent) != VeriSol.Old(_balances[msg.sender]))) || (VeriSol.Old(_balances[msg.sender]) < _totalSupply));
        VeriSol.Ensures((!(VeriSol.Old(basePercent) <= value)) || (VeriSol.Old(basePercent) <= _balances[to]));
        VeriSol.Ensures((!(VeriSol.Old(basePercent) <= value)) || (VeriSol.Old(_balances[msg.sender]) < VeriSol.SumMapping(_balances)));
        VeriSol.Ensures((!(VeriSol.Old(basePercent) <= value)) || (VeriSol.Old(_balances[msg.sender]) < _totalSupply));
        ...
        VeriSol.Ensures((!(VeriSol.Old(VeriSol.SumMapping(_balances)) != VeriSol.Old(_balances[msg.sender]))) || (VeriSol.Old(_balances[msg.sender]) < _totalSupply));
        VeriSol.Ensures((!(VeriSol.Old(_balances[msg.sender]) == VeriSol.Old(_totalSupply))) || (VeriSol.Old(basePercent) <= _balances[to]));
        VeriSol.Ensures((!(VeriSol.Old(_balances[msg.sender]) == VeriSol.Old(_totalSupply))) || (VeriSol.Old(_balances[msg.sender]) < VeriSol.SumMapping(_balances)));
        VeriSol.Ensures((!(VeriSol.Old(_balances[msg.sender]) == VeriSol.Old(_totalSupply))) || (VeriSol.Old(_balances[msg.sender]) < _totalSupply));
    ...
    function approve(address spender, uint256 value) public returns (bool) {
        ...
        VeriSol.Ensures(VeriSol.Old(uint256(_decimals)) == _decimals);
        VeriSol.Ensures(_decimals < value);
        VeriSol.Ensures((!(VeriSol.Old(_allowed[msg.sender][spender]) != 0)) || (_allowed[msg.sender][spender] == VeriSol.Old(_allowed[msg.sender][spender])));
        VeriSol.Ensures((!(spender == msg.sender)) || (_allowed[msg.sender][spender] == VeriSol.Old(_allowed[msg.sender][spender])));
        VeriSol.Ensures((!(VeriSol.Old(_allowed[msg.sender][spender]) == value)) || (_allowed[msg.sender][spender] == VeriSol.Old(_allowed[msg.sender][spender])));
