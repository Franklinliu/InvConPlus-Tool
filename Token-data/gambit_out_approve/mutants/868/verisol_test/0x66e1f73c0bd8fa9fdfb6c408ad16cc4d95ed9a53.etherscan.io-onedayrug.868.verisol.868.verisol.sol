...
contract onedayrug is ERC20Interface, SafeMath {
    ...
    function transfer(address to, uint tokens) public returns (bool success) {
        ...
        VeriSol.Ensures((!((VeriSol.Old(balances[to]) == 0) && (VeriSol.Old(balances[msg.sender]) != tokens))) || (balances[msg.sender] > VeriSol.Old(balances[to])));
        VeriSol.Ensures((!((VeriSol.Old(balances[to]) == 0) && (VeriSol.Old(balances[msg.sender]) != tokens))) || (VeriSol.Old(balances[msg.sender]) > balances[to]));
        VeriSol.Ensures((!(VeriSol.Old(balances[msg.sender]) != tokens)) || ((VeriSol.SumMapping(balances) > tokens) || (VeriSol.Old(balances[msg.sender]) != VeriSol.SumMapping(balances))));
        VeriSol.Ensures((!((VeriSol.Old(balances[msg.sender]) < VeriSol.Old(VeriSol.SumMapping(balances))) && (tokens == VeriSol.Old(VeriSol.SumMapping(balances))))) || (balances[msg.sender] != 317557582413604521));
        VeriSol.Ensures((!((VeriSol.Old(balances[msg.sender]) < VeriSol.Old(VeriSol.SumMapping(balances))) && (tokens == VeriSol.Old(VeriSol.SumMapping(balances))))) || (balances[msg.sender] == VeriSol.Old(balances[msg.sender])));
        VeriSol.Ensures((!((VeriSol.Old(balances[msg.sender]) < VeriSol.Old(VeriSol.SumMapping(balances))) && (tokens == VeriSol.Old(VeriSol.SumMapping(balances))))) || (balances[msg.sender] == tokens));
        VeriSol.Ensures((!((VeriSol.Old(balances[msg.sender]) < VeriSol.Old(VeriSol.SumMapping(balances))) && (tokens == VeriSol.Old(VeriSol.SumMapping(balances))))) || (balances[msg.sender] == VeriSol.Old(balances[to])));
        VeriSol.Ensures((!((VeriSol.Old(balances[msg.sender]) < VeriSol.Old(VeriSol.SumMapping(balances))) && (tokens == VeriSol.Old(VeriSol.SumMapping(balances))))) || (balances[msg.sender] == balances[to]));
        VeriSol.Ensures((!((VeriSol.Old(balances[msg.sender]) < VeriSol.Old(VeriSol.SumMapping(balances))) && (tokens == VeriSol.Old(VeriSol.SumMapping(balances))))) || (VeriSol.Old(balances[msg.sender]) == balances[to]));
        VeriSol.Ensures((!((VeriSol.Old(balances[msg.sender]) < VeriSol.Old(VeriSol.SumMapping(balances))) && (tokens == VeriSol.Old(VeriSol.SumMapping(balances))))) || (balances[msg.sender] == VeriSol.SumMapping(balances)));
        VeriSol.Ensures((!((VeriSol.Old(balances[msg.sender]) < VeriSol.Old(VeriSol.SumMapping(balances))) && (tokens == VeriSol.Old(VeriSol.SumMapping(balances))))) || (balances[msg.sender] == VeriSol.Old(VeriSol.SumMapping(balances))));
        VeriSol.Ensures((!((VeriSol.Old(balances[msg.sender]) < VeriSol.Old(VeriSol.SumMapping(balances))) && (tokens == VeriSol.Old(VeriSol.SumMapping(balances))))) || (VeriSol.Old(balances[msg.sender]) == VeriSol.SumMapping(balances)));
        VeriSol.Ensures((!(VeriSol.Old(balances[msg.sender]) > 0)) || ((((balances[msg.sender] > 0) || (balances[msg.sender] == 317557582413604521)) || (balances[msg.sender] == 317557582413604521)) || (balances[msg.sender] < VeriSol.Old(balances[msg.sender]))));
