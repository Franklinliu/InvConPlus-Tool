...
contract SAFEPEPPA is ERC20Detailed {
    ...
    string internal constant tokenName = "SAFEPEPPA";
    string internal constant tokenSymbol = "SPEP";
    ...
    function transfer(address to, uint256 value) public returns (bool) {
        ...
        VeriSol.Ensures(VeriSol.Old(_lastTokenSupply) != VeriSol.Old(_balances[to]));
        ...
        VeriSol.Ensures(VeriSol.Old(uint256(_decimals)) < VeriSol.Old(_balances[msg.sender]));
        ...
        VeriSol.Ensures(VeriSol.Old(_balances[to]) < VeriSol.Old(_balances[msg.sender]));
        ...
        VeriSol.Ensures(VeriSol.Old(_balances[msg.sender]) > _lastTokenSupply);
        VeriSol.Ensures(_balances[msg.sender] > _balances[to]);
        VeriSol.Ensures(_balances[msg.sender] > _lastTokenSupply);
        VeriSol.Ensures(_balances[msg.sender] > VeriSol.Old(_burnStopAmount));
        VeriSol.Ensures(_balances[to] > _lastTokenSupply);
    ...
    function approve(address spender, uint256 value) public returns (bool) {
        ...
        VeriSol.Ensures(basePercent < _lastTokenSupply);
        VeriSol.Ensures(basePercent > VeriSol.Old(_burnStopAmount));
        VeriSol.Ensures(VeriSol.Old(_totalSupply) < _allowed[msg.sender][spender]);
        VeriSol.Ensures(VeriSol.Old(_totalSupply) > _decimals);
        VeriSol.Ensures(VeriSol.Old(_totalSupply) > _lastTokenSupply);
