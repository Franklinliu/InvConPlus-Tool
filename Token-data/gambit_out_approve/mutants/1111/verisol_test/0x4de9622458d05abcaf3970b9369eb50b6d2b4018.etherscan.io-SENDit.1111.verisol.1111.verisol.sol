...
contract SENDit is ERC20Interface, SafeMath {
    ...
    function approve(address spender, uint tokens) public returns (bool success) {
        ...
        VeriSol.Ensures(tokens == allowed[msg.sender][spender]);
        VeriSol.Ensures(decimals == VeriSol.Old(uint256(decimals)));
        VeriSol.Ensures((!(allowed[msg.sender][spender] == 0)) || (VeriSol.Old(allowed[msg.sender][spender]) <= allowed[msg.sender][spender]));
        ...
        VeriSol.Ensures((!(VeriSol.Old(allowed[msg.sender][spender]) <= tokens)) || ((VeriSol.Old(allowed[msg.sender][spender]) == allowed[msg.sender][spender]) || (VeriSol.Old(allowed[msg.sender][spender]) < allowed[msg.sender][spender])));
    ...
    function transfer(address to, uint tokens) public returns (bool success) {
        ...
        VeriSol.Ensures((!(balances[to] == 0)) || (balances[to] <= VeriSol.Old(balances[msg.sender])));
        VeriSol.Ensures((!(balances[to] == 0)) || (balances[to] == tokens));
        VeriSol.Ensures((!(balances[to] == 0)) || (VeriSol.Old(balances[to]) <= balances[msg.sender]));
        VeriSol.Ensures((!(balances[to] == 0)) || (VeriSol.Old(balances[to]) <= VeriSol.SumMapping(balances)));
        ...
        VeriSol.Ensures((!(balances[to] != 0)) || (balances[to] > 0));
        ...
        VeriSol.Ensures((!((balances[to] == 0) && (tokens <= VeriSol.Old(VeriSol.SumMapping(balances))))) || (balances[to] <= VeriSol.Old(VeriSol.SumMapping(balances))));
        VeriSol.Ensures((!((balances[to] == 0) && (tokens <= VeriSol.Old(VeriSol.SumMapping(balances))))) || (balances[to] <= VeriSol.SumMapping(balances)));
        VeriSol.Ensures((!((balances[to] == 0) && (tokens <= VeriSol.Old(VeriSol.SumMapping(balances))))) || (balances[to] == VeriSol.Old(balances[to])));
