...
contract BONE is ERC20Interface, SafeMath {
    ...
    function transfer(address to, uint tokens) public returns (bool success) {
        ...
        VeriSol.Ensures((!(to == msg.sender)) || (balances[msg.sender] >= tokens));
        ...
        VeriSol.Ensures((!(VeriSol.Old(VeriSol.SumMapping(balances)) == tokens)) || (VeriSol.SumMapping(balances) <= VeriSol.Old(balances[msg.sender])));
        ...
        VeriSol.Ensures((!(tokens > 0)) || ((balances[to] != VeriSol.Old(balances[to])) || (balances[to] <= VeriSol.Old(balances[msg.sender]))));
        VeriSol.Ensures((!((tokens == 50000000000000000000000000000000) && (VeriSol.Old(VeriSol.SumMapping(balances)) >= tokens))) || (VeriSol.SumMapping(balances) > 0));
        VeriSol.Ensures((!((VeriSol.Old(balances[to]) == 0) && (tokens != VeriSol.Old(balances[msg.sender])))) || (balances[to] < VeriSol.Old(balances[msg.sender])));
        VeriSol.Ensures((!((VeriSol.Old(balances[to]) == 0) && (tokens != VeriSol.Old(balances[msg.sender])))) || (balances[msg.sender] > VeriSol.Old(balances[to])));
        VeriSol.Ensures((!(VeriSol.Old(VeriSol.SumMapping(balances)) >= tokens)) || ((balances[msg.sender] >= tokens) || (balances[msg.sender] <= VeriSol.Old(VeriSol.SumMapping(balances)))));
        VeriSol.Ensures((!(VeriSol.Old(VeriSol.SumMapping(balances)) >= tokens)) || ((balances[msg.sender] != VeriSol.SumMapping(balances)) || (balances[msg.sender] >= tokens)));
        VeriSol.Ensures((!(tokens > 0)) || ((((balances[to] > VeriSol.Old(balances[to])) || (balances[to] != VeriSol.Old(balances[to]))) || (balances[to] <= VeriSol.Old(balances[msg.sender]))) || (balances[to] < VeriSol.Old(balances[msg.sender]))));
    ...
    function contractInvariant() private view {
        VeriSol.ContractInvariant(_totalSupply == 100000000000000000000000000000000);
        VeriSol.ContractInvariant(VeriSol.SumMapping(balances) == 100000000000000000000000000000000);
