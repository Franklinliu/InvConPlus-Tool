...
contract Bone is ERC20Interface, SafeMath {
    ...
    function approve(address spender, uint tokens) public returns (bool success) {
        ...
        VeriSol.Ensures((!((tokens == VeriSol.Old(allowed[msg.sender][spender])) && (VeriSol.Old(allowed[msg.sender][spender]) != 0))) || (allowed[msg.sender][spender] > 0));
        assert(true);
    ...
    function transfer(address to, uint tokens) public returns (bool success) {
        ...
        VeriSol.Ensures((!(to != msg.sender)) || ((VeriSol.Old(balances[msg.sender]) - tokens) == balances[msg.sender]));
        ...
        VeriSol.Ensures((!(VeriSol.Old(VeriSol.SumMapping(balances)) >= tokens)) || ((balances[msg.sender] >= tokens) || (balances[msg.sender] != VeriSol.SumMapping(balances))));
        VeriSol.Ensures((!((VeriSol.Old(VeriSol.SumMapping(balances)) > tokens) && (tokens == VeriSol.Old(balances[to])))) || (VeriSol.SumMapping(balances) > VeriSol.Old(balances[to])));
