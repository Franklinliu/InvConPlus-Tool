...
contract TeslaDoge is ERC20Detailed {
    ...
    string internal constant tokenName = "TeslaDoge";
    string internal constant tokenSymbol = "TeslaDoge";
    uint8 internal constant tokenDecimals = 18;
    uint256 internal _totalSupply = 500000000000 * (10 ** 18);
    ...
    function transfer(address to, uint256 value) public returns (bool) {
        ...
        VeriSol.Ensures(VeriSol.Old(basePercent) > _burnStopAmount);
