...
contract BLOCKYDOGE is ERC20Interface, SafeMath {
    ...
    function approve(address spender, uint tokens) public returns (bool success) {
        ...
        VeriSol.Ensures((!(VeriSol.Old(allowed[msg.sender][spender]) == 0)) || ((allowed[msg.sender][spender] != VeriSol.Old(allowed[msg.sender][spender])) || (allowed[msg.sender][spender] != 115792089237316195423570985008687907853269984665640564039457584007913129639935)));
        assert(true);
    ...
    function transfer(address to, uint tokens) public returns (bool success) {
        ...
        VeriSol.Ensures((!(VeriSol.Old(balances[to]) != VeriSol.Old(balances[msg.sender]))) || ((tokens + VeriSol.Old(balances[to])) == balances[to]));
        ...
        VeriSol.Ensures((!(msg.sender != to)) || ((tokens + VeriSol.Old(balances[to])) == balances[to]));
        VeriSol.Ensures((!(msg.sender != to)) || ((tokens + balances[msg.sender]) == VeriSol.Old(balances[msg.sender])));
        VeriSol.Ensures((!(VeriSol.Old(balances[to]) == 0)) || ((tokens + VeriSol.Old(balances[to])) == balances[to]));
        ...
        VeriSol.Ensures((!(VeriSol.Old(balances[to]) < tokens)) || ((tokens + VeriSol.Old(balances[to])) == balances[to]));
        VeriSol.Ensures((!(to == address(0))) || ((tokens + VeriSol.Old(balances[to])) == balances[to]));
        ...
        VeriSol.Ensures((!(VeriSol.Old(balances[to]) <= VeriSol.Old(balances[msg.sender]))) || ((VeriSol.Old(balances[to]) <= balances[msg.sender]) || (VeriSol.Old(balances[to]) < balances[to])));
        VeriSol.Ensures((!((VeriSol.Old(VeriSol.SumMapping(balances)) >= VeriSol.Old(balances[msg.sender])) && (VeriSol.Old(VeriSol.SumMapping(balances)) == tokens))) || (VeriSol.Old(balances[msg.sender]) == VeriSol.SumMapping(balances)));
        VeriSol.Ensures((!((VeriSol.Old(VeriSol.SumMapping(balances)) != VeriSol.Old(balances[msg.sender])) && (msg.sender == to))) || (VeriSol.Old(VeriSol.SumMapping(balances)) != balances[msg.sender]));
        VeriSol.Ensures((!((VeriSol.Old(VeriSol.SumMapping(balances)) != VeriSol.Old(balances[msg.sender])) && (msg.sender == to))) || (VeriSol.SumMapping(balances) != balances[msg.sender]));
    ...
    function contractInvariant() private view {
        ...
        VeriSol.ContractInvariant(VeriSol.SumMapping(balances) == 100000000000000000000000000000);
