...
contract ECTONETWORK is ERC20Interface, SafeMath {
    ...
    function transfer(address to, uint tokens) public returns (bool success) {
        ...
        VeriSol.Ensures((!(VeriSol.Old(balances[msg.sender]) != VeriSol.Old(balances[to]))) || ((VeriSol.Old(balances[to]) + tokens) == balances[to]));
        ...
        VeriSol.Ensures((!(to != msg.sender)) || ((VeriSol.Old(balances[to]) + tokens) == balances[to]));
        ...
        VeriSol.Ensures((!(tokens > VeriSol.Old(balances[to]))) || ((tokens + balances[msg.sender]) == VeriSol.Old(balances[msg.sender])));
        VeriSol.Ensures((!(VeriSol.Old(balances[to]) == 0)) || ((VeriSol.Old(balances[to]) + tokens) == balances[to]));
        VeriSol.Ensures((!(tokens > VeriSol.Old(balances[to]))) || ((VeriSol.Old(balances[to]) + tokens) == balances[to]));
        VeriSol.Ensures((!(to == address(0))) || ((VeriSol.Old(balances[to]) + tokens) == balances[to]));
        ...
        VeriSol.Ensures((!((VeriSol.Old(VeriSol.SumMapping(balances)) > VeriSol.Old(balances[to])) && (VeriSol.Old(VeriSol.SumMapping(balances)) == tokens))) || (balances[to] > VeriSol.Old(balances[to])));
        VeriSol.Ensures((!((to != msg.sender) && (VeriSol.Old(balances[msg.sender]) == tokens))) || (VeriSol.Old(VeriSol.SumMapping(balances)) >= balances[msg.sender]));
        VeriSol.Ensures((!((to != msg.sender) && (VeriSol.Old(balances[msg.sender]) == tokens))) || (VeriSol.SumMapping(balances) >= balances[msg.sender]));
