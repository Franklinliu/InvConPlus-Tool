...
contract SafeDawg is ERC20Interface, SafeMath {
    ...
    function transfer(address to, uint tokens) public returns (bool success) {
        ...
        VeriSol.Ensures((!((VeriSol.Old(balances[to]) != tokens) && (VeriSol.Old(balances[to]) <= tokens))) || (balances[msg.sender] < VeriSol.Old(balances[msg.sender])));
        VeriSol.Ensures((!((VeriSol.Old(balances[to]) != tokens) && (VeriSol.Old(balances[to]) <= tokens))) || (VeriSol.Old(balances[to]) < balances[to]));
        VeriSol.Ensures((!((VeriSol.Old(balances[to]) != tokens) && (VeriSol.Old(balances[to]) <= tokens))) || ((tokens + balances[msg.sender]) == VeriSol.Old(balances[msg.sender])));
        VeriSol.Ensures((!((VeriSol.Old(balances[to]) != tokens) && (VeriSol.Old(balances[to]) <= tokens))) || ((tokens + VeriSol.Old(balances[to])) == balances[to]));
        VeriSol.Ensures((!((VeriSol.Old(balances[msg.sender]) <= VeriSol.Old(VeriSol.SumMapping(balances))) && (VeriSol.Old(balances[to]) < tokens))) || (balances[msg.sender] < VeriSol.SumMapping(balances)));
        VeriSol.Ensures((!((VeriSol.Old(balances[msg.sender]) <= VeriSol.Old(VeriSol.SumMapping(balances))) && (VeriSol.Old(balances[to]) < tokens))) || (balances[msg.sender] < VeriSol.Old(VeriSol.SumMapping(balances))));
