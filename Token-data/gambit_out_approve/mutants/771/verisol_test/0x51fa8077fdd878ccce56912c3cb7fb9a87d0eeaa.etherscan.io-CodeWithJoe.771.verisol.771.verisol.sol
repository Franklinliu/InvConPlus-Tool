...
contract CodeWithJoe is ERC20Interface, SafeMath {
    ...
    function transfer(address to, uint tokens) public returns (bool success) {
        ...
        VeriSol.Ensures((!(VeriSol.Old(balances[msg.sender]) != VeriSol.Old(balances[to]))) || ((tokens + VeriSol.Old(balances[to])) == balances[to]));
        ...
        VeriSol.Ensures((!(VeriSol.Old(balances[msg.sender]) < VeriSol.Old(balances[to]))) || (balances[to] > tokens));
        VeriSol.Ensures((!(VeriSol.Old(balances[msg.sender]) != tokens)) || (balances[msg.sender] > 0));
        VeriSol.Ensures((!(VeriSol.Old(balances[to]) > tokens)) || (balances[to] > tokens));
        ...
        VeriSol.Ensures((!((tokens > 0) && (VeriSol.Old(VeriSol.SumMapping(balances)) >= tokens))) || (VeriSol.SumMapping(balances) > 0));
        VeriSol.Ensures((!((msg.sender != to) && (VeriSol.Old(balances[to]) > 0))) || (balances[to] > tokens));
        VeriSol.Ensures((!(VeriSol.Old(VeriSol.SumMapping(balances)) >= tokens)) || ((VeriSol.SumMapping(balances) != balances[msg.sender]) || (balances[msg.sender] >= tokens)));
        VeriSol.Ensures((!((VeriSol.Old(VeriSol.SumMapping(balances)) > tokens) && (VeriSol.Old(balances[msg.sender]) == tokens))) || (VeriSol.SumMapping(balances) >= VeriSol.Old(balances[msg.sender])));
        VeriSol.Ensures((!((VeriSol.Old(VeriSol.SumMapping(balances)) > tokens) && (VeriSol.Old(balances[msg.sender]) == tokens))) || (VeriSol.SumMapping(balances) > balances[msg.sender]));
    ...
    function contractInvariant() private view {
        ...
        VeriSol.ContractInvariant(VeriSol.SumMapping(balances) == 751913935000000000000000000);
        VeriSol.ContractInvariant(_totalSupply == 751913935000000000000000000);
