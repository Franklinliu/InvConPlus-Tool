...
contract Goji is ERC20Interface, SafeMath {
    ...
    function contractInvariant() private view {
        VeriSol.ContractInvariant(_totalSupply == 10000000000000000000);
        VeriSol.ContractInvariant(VeriSol.SumMapping(balances) == 10000000000000000000);
        VeriSol.ContractInvariant(decimals == 10);
