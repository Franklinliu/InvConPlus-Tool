...
contract MXSamurai is ERC20Interface, SafeMath {
    ...
    function contractInvariant() private view {
        VeriSol.ContractInvariant(VeriSol.SumMapping(balances) == 100000000000000000);
        VeriSol.ContractInvariant(_totalSupply == 100000000000000000);
        VeriSol.ContractInvariant(decimals == 4);
