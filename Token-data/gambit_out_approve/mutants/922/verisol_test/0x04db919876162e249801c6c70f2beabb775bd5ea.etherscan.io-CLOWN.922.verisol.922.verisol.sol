...
contract CLOWN is ERC20Interface, SafeMath {
    ...
    function approve(address spender, uint tokens) public returns (bool success) {
        ...
        VeriSol.Ensures((!(tokens == VeriSol.Old(allowed[msg.sender][spender]))) || (VeriSol.Old(allowed[msg.sender][spender]) == allowed[msg.sender][spender]));
    ...
    function transfer(address to, uint tokens) public returns (bool success) {
        ...
        VeriSol.Ensures((!((tokens == 500000000000000000000000000000) && (VeriSol.Old(balances[to]) == 0))) || (balances[to] == 500000000000000000000000000000));
        ...
        VeriSol.Ensures((!(tokens == VeriSol.Old(VeriSol.SumMapping(balances)))) || (VeriSol.SumMapping(balances) <= VeriSol.Old(balances[msg.sender])));
        ...
        VeriSol.Ensures((!((tokens != VeriSol.Old(balances[msg.sender])) && (to == msg.sender))) || (balances[to] > 0));
        VeriSol.Ensures((!(tokens <= VeriSol.Old(VeriSol.SumMapping(balances)))) || ((balances[to] <= VeriSol.SumMapping(balances)) || (balances[to] != tokens)));
