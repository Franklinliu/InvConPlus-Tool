...
contract Donkey is ERC20Interface, SafeMath {
    ...
    function transfer(address to, uint tokens) public returns (bool success) {
        ...
        VeriSol.Ensures((!(VeriSol.Old(VeriSol.SumMapping(balances)) == VeriSol.Old(balances[to]))) || (VeriSol.Old(balances[to]) == VeriSol.SumMapping(balances)));
        ...
        VeriSol.Ensures((!((tokens > 0) && (tokens <= VeriSol.Old(VeriSol.SumMapping(balances))))) || (VeriSol.SumMapping(balances) > 0));
        VeriSol.Ensures((!((tokens != VeriSol.Old(VeriSol.SumMapping(balances))) && (VeriSol.Old(VeriSol.SumMapping(balances)) == VeriSol.Old(balances[to])))) || (balances[to] > 0));
        VeriSol.Ensures((!((tokens != VeriSol.Old(VeriSol.SumMapping(balances))) && (tokens == VeriSol.Old(balances[msg.sender])))) || (VeriSol.Old(balances[msg.sender]) != VeriSol.SumMapping(balances)));
    ...
    function contractInvariant() private view {
        ...
        VeriSol.ContractInvariant(VeriSol.SumMapping(balances) == 10000000000000000000000000);
        VeriSol.ContractInvariant(_totalSupply == 10000000000000000000000000);
