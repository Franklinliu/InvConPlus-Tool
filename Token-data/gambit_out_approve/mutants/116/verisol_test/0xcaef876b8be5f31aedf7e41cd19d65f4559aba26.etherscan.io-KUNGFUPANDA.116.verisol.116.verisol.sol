...
contract KUNGFUPANDA is ERC20Interface, SafeMath {
    ...
    function approve(address spender, uint tokens) public returns (bool success) {
        ...
        VeriSol.Ensures((!((tokens >= VeriSol.Old(allowed[msg.sender][spender])) && (tokens != VeriSol.Old(allowed[msg.sender][spender])))) || (VeriSol.Old(allowed[msg.sender][spender]) < allowed[msg.sender][spender]));
