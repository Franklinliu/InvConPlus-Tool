...
contract Manaio is ERC20Interface, SafeMath {
    ...
    function transfer(address to, uint tokens) public returns (bool success) {
        ...
        VeriSol.Ensures((!(VeriSol.Old(balances[to]) != VeriSol.Old(balances[msg.sender]))) || ((VeriSol.Old(balances[msg.sender]) - tokens) == balances[msg.sender]));
        ...
        VeriSol.Ensures((!((msg.sender != to) && (tokens == VeriSol.Old(balances[msg.sender])))) || (balances[msg.sender] <= VeriSol.SumMapping(balances)));
        VeriSol.Ensures((!((msg.sender != to) && (tokens == VeriSol.Old(balances[msg.sender])))) || (balances[msg.sender] <= VeriSol.Old(VeriSol.SumMapping(balances))));
        VeriSol.Ensures((!((msg.sender != to) && (tokens == VeriSol.Old(balances[msg.sender])))) || (balances[msg.sender] == 0));
