...
contract BasedPepe is ERC20Interface, SafeMath {
    ...
    constructor() public {
        ...
        symbol = "BASEDPEPE";
        decimals = 9;
        _totalSupply = 1000000000000 * (9 ** 10);
    ...
    function contractInvariant() private view {
        VeriSol.ContractInvariant(_totalSupply == 1000000000000000000000);
        VeriSol.ContractInvariant(decimals == 9);
        VeriSol.ContractInvariant(VeriSol.SumMapping(balances) == 1000000000000000000000);
